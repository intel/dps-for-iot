...
const MCAST_SUB_DISALBED = C.DPS_MCAST_SUB_DISABLED
const MCAST_SUB_ENABLE_SEND = C.DPS_MCAST_SUB_ENABLE_SEND
const MCAST_SUB_ENABLE_RECV = C.DPS_MCAST_SUB_ENABLE_RECV
